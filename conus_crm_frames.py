...
def fig_layout(extent=conus, polygon_xy=None):
...
def plot_da_with_crms(da, crm_ds, extent=conus, da_kwargs={'cmap': cmclimate.cm.WhiteBlueGreenYellowRed, 'vmin': 0, 'vmax': 40}):    
...
if __name__ == "__main__":
    ...
    ffmpeg -pattern_type glob -r 30 -i "*.png" -c:v libx264 -vf scale=1280:-2 -pix_fmt yuv420p conus_crm_0002-05.mp4
      options: -r framerate 
